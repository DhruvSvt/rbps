            ...
            <div class="row">
                <div class="offset-lg-2 col-lg-8">
                    <div class="card box p-3">
                        ...
                        <form class="contact-form mt-30 contact-field " enctype="multipart/form-data" action="{{ route('admissionsform.store') }}"
                           ...
                           @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <select name="admitted_class" class="form-select"
                                        style="height: 45px; padding:0 13px;" required>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea placeholder="Address" class="form-control" id="address" rows="2"
                                        name="address" cols="50" required></textarea>
                                </div>
                                <div class="form-group col-sm-12 col-md-4">
                            ...
                            <div class="slider-btn">
                                <button class="btn btn btn-primary w-100" data-animation="fadeInRight"
                                    data-delay=".8s"><span>Submit
                                        Now</span></button>
                            </div>
                        </form>
                    </div>
